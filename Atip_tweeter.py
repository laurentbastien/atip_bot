...
def get_tweet_message(agency, id_query)
  all_messages = {}
  ...
  tweetagency = agency
  ink = "du94lycnnfr2r.cloudfront.net/cdn-requests/"

  return tweetagency+" "+tweet+" "+id_query+" "+"release."+" "+link+id_query+".pdf"


get_tweet_message("Insert the agency", "Insert the ATIP_ID")
